        ...
        <div className="w-[90%] max-w-7xl mx-auto flex flex-wrap justify-evenly space-y-8 md:space-y-0">
          ...
          <div className="w-1/2 md:w-1/4 lg:flex-1 px-4 items-center">
            ...
            <ul className="space-y-4 text-sm text-justify">
              {["Home", "Features", "How it works"].map((link, index) => (
                <li key={index}>
                  <a href="#" className="hover:text-red-500 text-gray-200">
                    {link}
                  </a>
                </li>
              ))}
            ...
            <div className="flex flex-wrap gap-2 ml-24">
              ...
              <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
                <DialogTrigger asChild>
                  <button
                    className="relative inline-flex h-auto w-[230px] bg-custom-gradient2 hover:from-pink-600 hover:to-orange-600 border-2 border-neutral-100 rounded-[8px]"
