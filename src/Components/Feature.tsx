...
const FeaturesSection = forwardRef<HTMLElement>((_, ref) => {
  return (
    <section
      ref={ref}
      className="w-full overflow-hidden text-white py-16 px-6 sm:px-8"
    >
      ...
      <div className="flex justify-center gap-4 items-center mt-[-24]">
        <Dialog>
          <DialogTrigger asChild>
            <button className="relative inline-flex h-auto bg-gradient-to-r  from-orange-500 to-orange-600 overflow-hidden border-2 border-white rounded-[8px]">
